...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cart.cart'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    nutritions: Schema.Attribute.String;
...
export interface ApiCategoriesExploreCategoriesExplore
  extends Struct.CollectionTypeSchema {
  collectionName: 'categories_explores';
  info: {
    description: '';
    displayName: 'Categories explore';
    pluralName: 'categories-explores';
    singularName: 'categories-explore';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    categoryExploreId: Schema.Attribute.UID & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categories-explore.categories-explore'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductsMiniMandiProductsMiniMandi
  extends Struct.CollectionTypeSchema {
  collectionName: 'products_mini_mandis';
  info: {
    description: '';
    displayName: 'Products-Mini-Mandi';
    pluralName: 'products-mini-mandis';
    singularName: 'products-mini-mandi';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::products-mini-mandi.products-mini-mandi'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    nutritions: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categories-explore.categories-explore': ApiCategoriesExploreCategoriesExplore;
      ...
      'api::products-mini-mandi.products-mini-mandi': ApiProductsMiniMandiProductsMiniMandi;
